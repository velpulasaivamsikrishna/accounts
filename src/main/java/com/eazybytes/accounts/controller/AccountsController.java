...
@Validated
@Tag(name = "CRUD REST APIs for accounts in EazyBank", description = "CRUD REST APIs in EazyBank to CREATE,UPDATE,FETCH and DELETE")
public class AccountsController {
    ...
    @Operation(
            summary = "Delete Accounr Details Rest API",
            description = "REST API to delete Customer And Account details based on mobileNumber"
    )
